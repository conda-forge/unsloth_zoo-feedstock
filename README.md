...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/unsloth_zoo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/unsloth_zoo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add unsloth_zoo
# for installing globally
pixi global install unsloth_zoo
```
...
It is possible to list all of the versions of `unsloth_zoo` available on your platform:
...
```
pixi search unsloth_zoo --channel conda-forge
```
